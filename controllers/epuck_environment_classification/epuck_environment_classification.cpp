...
EPuck_Environment_Classification::EPuck_Environment_Classification() : m_pcWheels(NULL),
...
EPuck_Environment_Classification::CollectedData::CollectedData() : count(1) {}

EPuck_Environment_Classification::Opinion::Opinion() : countedCellOfActualOpinion(0) {}

EPuck_Environment_Classification::Movement::Movement() : walkTime(3),
                                                         actualDirection(0) {}
...
void EPuck_Environment_Classification::Diffusing()
{
    ...
    else if (m_sStateData.remainingDiffusingTime == 0 || eventTrials > 20)
    { // Time to change to exploration state
